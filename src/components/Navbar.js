          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            <ul className="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li className="nav-item dropdown">
                ...
                <ul className="dropdown-menu">
                  ...
                  <li><a className="dropdown-item" href="/">Prospectus</a></li>
                  <li><hr className="dropdown-divider" /></li>
                  <li><a className="dropdown-item" href="/">Contracts</a></li>
                </ul>
              </li>
              <li className="nav-item">
            ...
            <form className="d-flex" role="search">
              ...
              <div className="form-check form-switch">
                <input className="form-check-input mx-4" type="checkbox" role="switch" id="flexSwitchCheckDefault" onClick={props.toggleMode} />
